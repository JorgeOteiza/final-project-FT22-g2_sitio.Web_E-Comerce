  ...
  return (
    <main className="profile-page">
      <div className="container profile-container">
        ...
        <section className="profile-stats"><div><i className="fa-regular fa-heart" /><span>Favoritos</span><strong>{(store.favorites || []).length}</strong></div><div><i className="fa-solid fa-bag-shopping" /><span>En el carrito</span><strong>{cartUnits}</strong></div><div><i className="fa-solid fa-receipt" /><span>Compras</span><strong>{historyCount}</strong></div></section>
